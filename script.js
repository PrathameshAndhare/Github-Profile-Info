    ...
    if (response.ok) {
        ...
        document.getElementById("result").innerHTML = `
            <div class="profile">
                ...
                <div class="media">
                    <p>
                        <span class="media-value"> Country - ${data.location || ' Not Available'}</span>
                    </p>
                    <p>
                        <span class="media-value">Link - ${data.blog || 'Not Available'}</span>
                    </p>
                    <p>
                        <span class="media-value">Twitter - ${data.twitter_username || 'Not Available'}</span>
                    </p>
                    <p>
                        <span class="media-value">Company - ${data.company || 'Not Available'}</span>
                    </p>
                </div>
            </div>
        </div>
